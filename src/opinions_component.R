...
opinionchange=function(distribution=c(frac_opp_0,frac_neut_0,frac_supp_0),evidence_t_1,evidence_effect=evidenceeffect,selfsimparams=homophily,force=force_params,policychange_t_1=0,policyopinionfeedback=policyopinionfeedback_param,adopt_t_1,ced=ced_param){
  network=networkfunc(distribution,selfsimparams)
  force[1,3]=force[1,3]+(ced*(adopt_t_1[3]-adopt_t_1[1]))
  force[2,3]=force[2,3]+(ced*(adopt_t_1[3]-adopt_t_1[2])) #credibility-enhancing display effect increases the persuasive force of climate policy supporters depending on the difference in individual adoption rates
