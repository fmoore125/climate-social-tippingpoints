...
policychange=function(distribution_t,policy_t_1,responsiveness=pol_response){
  if(distribution_t[1]>distribution_t[3]){
    ...
    if(distribution_t[1]/distribution_t[3]>responsiveness) change=-1*(1-distribution_t[2])^2*((distribution_t[1]/distribution_t[3])-responsiveness)^1.5
  }
  if(distribution_t[3]>=distribution_t[1]){
    ...
    if(distribution_t[3]/distribution_t[1]>responsiveness) change=(1-distribution_t[2])^2*((distribution_t[3]/distribution_t[1])-responsiveness)^1.5
  }
